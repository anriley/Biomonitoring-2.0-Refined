...
umap_plots_community_combined <- ggarrange(com_umap_plots[["F230R"]][["esv"]][["default"]][[beta_type]]+ggtitle("ESV")+theme(plot.title = element_text(size = 20,hjust = 0.5),legend.title = element_text(size=16),legend.text = element_text(size=16)),
                                           com_umap_plots[["F230R"]][["otu"]][["default"]][[beta_type]]+ggtitle("OTU")+theme(plot.title = element_text(size = 20,hjust = 0.5)),
                                           com_umap_plots[["F230R"]][["taxon"]][["default"]][[beta_type]]+ggtitle("Isolated species")+theme(plot.title = element_text(size = 20,hjust = 0.5)),
                                           
                                           com_umap_plots[["MLJG"]][["esv"]][["default"]][[beta_type]]+ggtitle(""),
                                           com_umap_plots[["MLJG"]][["otu"]][["default"]][[beta_type]]+ggtitle(""),
                                           com_umap_plots[["MLJG"]][["taxon"]][["default"]][[beta_type]]+ggtitle(""),
                                           
                                           ncol=3,nrow=2,common.legend = TRUE,legend = "right",
                                           labels=c("A","","","B","",""))


ggsave(paste(indir,"Figures/unused_figure_",variables_io,".png",sep=""),
       umap_plots_community_combined, height=16,width=32,units="cm", bg = 'white')
